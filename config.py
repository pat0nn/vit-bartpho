...
TEST_DATA_PATH = '/kaggle/input/uit-viic/annotations/uitviic_captions_test2017_v2.json'
TRAIN_IMAGES_DIR = '/kaggle/input/uit-viic/uitviic_train2017'
TEST_IMAGES_DIR = '/kaggle/input/uit-viic/uitviic_test2017'

GROUNDTRUTH_FILE = '/kaggle/working/vit-bartpho/data/groundtruth_captions_test2017.json'
...
OUTPUT_DIR = './output'
LOGS_DIR = './logs'
WANDB_PROJECT = "ViT-BARTpho_UIT-ViIC_4-19"
