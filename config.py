...
# COCO_ANNOTATION_FILE = '/mnt/nvme/Algo/UIT-ViIC/annotations/uitviic_captions_val2017_v2.json' 
...
GROUNDTRUTH_FILE = '/kaggle/working/vit-bartpho/data/uitviic_captions_val2017_v2.json'
COCO_ANNOTATION_FILE = '/kaggle/working/vit-bartpho/data/uitviic_captions_val2017_v2.json'

# Evaluation settings
USE_COCO_EVAL = True  # Whether to use COCO evaluation metrics
  # Path to COCO format annotation file
